...
data = np.loadtxt('NGC 7793 - Obs Vel.txt')
data1 = np.loadtxt('NGC 7793 - Star Vel.txt')
data2 = np.loadtxt('NGC 7793 - Gas Vel.txt')
errorBars = np.loadtxt('NGC 7793 - Error Bars.txt')
...
##chi distribution DARK MATTER----------------------------------------------
    ...
    #print 'chai: ', chi2
    chaiSort = []
    for i in sorted(chi2):
        chaiSort.append(i)

#print 'sort: chaiSort: ', chaiSort
    #print 'chai: ', np.sum(chi2)
    
    chiKeep.append(np.sum(chi2))
